...
def table1():
    ...
    Button(tb1,text = "1.ลาบเนื้อดิบ....60.บาท",command = menu1teble1).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "2.ลาบเนื้อสุก....60.บาท",command = menu2teble1).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "3.ลาบหมูสุก.....40.บาท",command = menu3teble1).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "4.ก้อยเนื้อดิบ....60.บาท",command = menu4teble1).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "5.ก้อยเนื้อสุก....60.บาท",command = menu5teble1).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "6.ต้มแซ่บ.........50.บาท",command = menu6teble1).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "7.ต้มขม...........50.บาท",command = menu7teble1).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "8.อ่อมเนื้อ.......50.บาท",command = menu8teble1).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "9.คอหมูย่าง.....60.บาท",command = menu9teble1).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "10.ข้าวเหนียว....10.บาท",command = menu10teble1).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "11.น้ำอัดลม......15.บาท",command = menu11teble1).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "12.เบียร์.........70.บาท",command = menu12teble1).pack(pady = 2,side = TOP,fill = X)
...
def table2():
    ...
    Label(tb1,text = "กรุณาเลือกเมนูอาหารและเครื่องดื่ม",bg = "#F5DEB3",wraplength=400,height = 2).pack(fill = X)
    Button(tb1,text = "1.ลาบเนื้อดิบ....60.บาท",command = menu1teble2).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "2.ลาบเนื้อสุก....60.บาท",command = menu2teble2).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "3.ลาบหมูสุก.....40.บาท",command = menu3teble2).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "4.ก้อยเนื้อดิบ....60.บาท",command = menu4teble2).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "5.ก้อยเนื้อสุก....60.บาท",command = menu5teble2).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "6.ต้มแซ่บ.........50.บาท",command = menu6teble2).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "7.ต้มขม...........50.บาท",command = menu7teble2).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "8.อ่อมเนื้อ.......50.บาท",command = menu8teble2).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "9.คอหมูย่าง.....60.บาท",command = menu9teble2).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "10.ข้าวเหนียว....10.บาท",command = menu10teble2).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "11.น้ำอัดลม......15.บาท",command = menu11teble2).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "12.เบียร์.........70.บาท",command = menu12teble2).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "ยืนยันรายการ",bg = "#00FA9A",command = check1).pack(pady = 2,side = BOTTOM)
    tb1.mainloop()
def table3():
    global tb1
    ...
    Label(tb1,text = "กรุณาเลือกเมนูอาหารและเครื่องดื่ม",bg = "#F5DEB3",wraplength=400,height = 2).pack(fill = X)
    Button(tb1,text = "1.ลาบเนื้อดิบ....60.บาท",command = menu1teble3).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "2.ลาบเนื้อสุก....60.บาท",command = menu2teble3).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "3.ลาบหมูสุก.....40.บาท",command = menu3teble3).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "4.ก้อยเนื้อดิบ....60.บาท",command = menu4teble3).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "5.ก้อยเนื้อสุก....60.บาท",command = menu5teble3).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "6.ต้มแซ่บ.........50.บาท",command = menu6teble3).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "7.ต้มขม...........50.บาท",command = menu7teble3).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "8.อ่อมเนื้อ.......50.บาท",command = menu8teble3).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "9.คอหมูย่าง.....60.บาท",command = menu9teble3).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "10.ข้าวเหนียว....10.บาท",command = menu10teble3).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "11.น้ำอัดลม......15.บาท",command = menu11teble3).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "12.เบียร์.........70.บาท",command = menu12teble3).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "ยืนยันรายการ",bg = "#00FA9A",command = check1).pack(pady = 2,side = BOTTOM)
    tb1.mainloop()
def table4():
    global tb1
    ...
    Label(tb1,text = "กรุณาเลือกเมนูอาหารและเครื่องดื่ม",bg = "#F5DEB3",wraplength=400,height = 2).pack(fill = X)
    Button(tb1,text = "1.ลาบเนื้อดิบ....60.บาท",command = menu1teble4).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "2.ลาบเนื้อสุก....60.บาท",command = menu2teble4).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "3.ลาบหมูสุก.....40.บาท",command = menu3teble4).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "4.ก้อยเนื้อดิบ....60.บาท",command = menu4teble4).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "5.ก้อยเนื้อสุก....60.บาท",command = menu5teble4).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "6.ต้มแซ่บ.........50.บาท",command = menu6teble4).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "7.ต้มขม...........50.บาท",command = menu7teble4).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "8.อ่อมเนื้อ.......50.บาท",command = menu8teble4).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "9.คอหมูย่าง.....60.บาท",command = menu9teble4).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "10.ข้าวเหนียว....10.บาท",command = menu10teble4).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "11.น้ำอัดลม......15.บาท",command = menu11teble4).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "12.เบียร์.........70.บาท",command = menu12teble4).pack(pady = 2,side = TOP,fill = X)
    Button(tb1,text = "ยืนยันรายการ",bg = "#00FA9A",command = check1).pack(pady = 2,side = BOTTOM)
    tb1.mainloop()
